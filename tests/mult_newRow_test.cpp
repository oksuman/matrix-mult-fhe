...
template <int d> class MatrixMultNewRowTest : public ::testing::Test {
  protected:
    void SetUp() override {
        ...
        matMult = std::make_unique<MatrixMult_newRow<d>>(
    ...
    std::unique_ptr<MatrixMult_newRow<d>> matMult;
};

// Define the test fixture
template <typename T>
class MatrixMultNewRowTestFixture : public MatrixMultNewRowTest<T::value> {};

// Register the test suite
TYPED_TEST_SUITE_P(MatrixMultNewRowTestFixture);

// Define the test cases
TYPED_TEST_P(MatrixMultNewRowTestFixture, IdentityMultiplicationTest) {
...
TYPED_TEST_P(MatrixMultNewRowTestFixture, GeneralMultiplicationTest) {
    constexpr size_t d = TypeParam::value;
...
REGISTER_TYPED_TEST_SUITE_P(MatrixMultNewRowTestFixture,
...
INSTANTIATE_TYPED_TEST_SUITE_P(MatrixMultTests,             // Instance name
                               MatrixMultNewRowTestFixture, // Fixture name
                               TestSizes);