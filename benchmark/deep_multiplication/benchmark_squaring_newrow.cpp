// Matrix Squaring Benchmark - NewRow Algorithm
...
void runSquaringBenchmark(int numRuns = 1) {
    ...
    printSquaringBenchmarkHeader("NewRow", d, numRuns, multDepth, Scaling, cc->GetRingDimension());
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "============================================" << std::endl;
    std::cout << "  Matrix Squaring Benchmark - NewRow" << std::endl;
    std::cout << "============================================" << std::endl;
