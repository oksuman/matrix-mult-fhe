// Matrix Inversion Benchmark - NewCol Algorithm (Simple: upperbound scaling)
...
void runInversionBenchmark(int numRuns = 1) {
    std::cout << "\n========== NewCol-Simple Inversion d=" << d << " ==========" << std::endl;
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "============================================" << std::endl;
    std::cout << "  Matrix Inversion Benchmark - NewCol-Simple" << std::endl;
