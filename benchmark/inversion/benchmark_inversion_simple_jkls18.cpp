// Matrix Inversion Benchmark - JKLS18 Algorithm (Simple: upperbound scaling)
...
void runInversionBenchmark(int numRuns = 1) {
    std::cout << "\n========== JKLS18-Simple Inversion d=" << d << " ==========" << std::endl;
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "============================================" << std::endl;
    std::cout << "  Matrix Inversion Benchmark - JKLS18-Simple" << std::endl;
